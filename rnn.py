...
def train(sentence_tensor1,sentence_tensor2, original_score, rnn1, rnn2,learning_rate,criterion):
    ...
    for i in range(sentence_tensor1.size()[0]):
        output1, hidden1 = rnn1(torch.tensor([sentence_tensor1[i]]), hidden1)
    for i in range(sentence_tensor2.size()[0]):
        output2, hidden2 = rnn2(torch.tensor([sentence_tensor2[i]]), hidden2)
...
if __name__=='__main__':
    ...
    test_data_raw=get_word_vect(test_data_raw,word_dict)
